...
import { Camera, Edit2, LogOut, Mail, X } from 'lucide-react';
...
export function ProfileDialog({ 
    ...
    // If viewingUser is set but matches currentUser.id, it's also "Me"
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[400px] p-0 overflow-hidden bg-white gap-0">
