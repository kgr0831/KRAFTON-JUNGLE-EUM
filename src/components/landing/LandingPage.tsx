        ...
        <div className="min-h-screen bg-white selection:bg-indigo-100 selection:text-indigo-900 font-sans">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <Button variant="ghost" className="text-slate-600 hover:text-indigo-600" onClick={onLogin}>
                            로그인
                        </Button>
                        <Button className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-full px-6" onClick={onStart}>
                            무료로 시작하기
                        </Button>
                    </div>
                </div>
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-indigo-600 hover:bg-indigo-700 shadow-xl shadow-indigo-200" onClick={onStart}>
                                    무료로 시작하기 <ArrowRight className="ml-2 w-5 h-5" />
                                </Button>
                                <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full border-slate-300 hover:bg-slate-50 text-slate-700">
                                    <Play className="mr-2 w-5 h-5 fill-slate-700" /> 데모 영상 보기
                                </Button>
                            </div>
                        </motion.div>
                    </div>
                        ...
                        <div className="rounded-2xl border-4 border-slate-900/5 shadow-2xl overflow-hidden bg-slate-900 aspect-[16/9] relative group">
                            ...
                            <div className="absolute bottom-8 right-8 bg-white p-4 rounded-xl shadow-2xl max-w-sm border border-slate-100 animate-in slide-in-from-bottom duration-1000 delay-300">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <div className="text-sm font-bold text-slate-900">Meeting Archived</div>
                                </div>
                                <p className="text-xs text-slate-500">
                                    대화 내용과 화이트보드 스냅샷이 안전하게 저장되었습니다.
                                </p>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <FeatureCard 
                            ...
                            desc="네트워크가 끊겨도 걱정 없습니다. AWS 하이브리드 아키텍처로 대화와 음성을 실시간 저장하고, 회의 종료 시 자동 자산화합니다."
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-6 relative z-10 text-center text-white">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Button size="lg" className="h-16 px-10 text-xl rounded-full bg-white text-slate-900 hover:bg-slate-100" onClick={onStart}>
                            무료로 시작하기
                        </Button>
                        <Button size="lg" variant="outline" className="h-16 px-10 text-xl rounded-full border-slate-600 text-white hover:bg-white/10 hover:text-white hover:border-white">
                            도입 문의하기
                        </Button>
                    </div>
